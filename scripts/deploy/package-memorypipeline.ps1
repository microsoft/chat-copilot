...
dotnet publish "$PSScriptRoot/../../memorypipeline/CopilotChatMemoryPipeline.csproj" --configuration $BuildConfiguration --framework $DotNetFramework --runtime $TargetRuntime --self-contained --output "$publishOutputDirectory"
