import { makeStyles, shorthands, tokens, Accordion, AccordionItem, AccordionHeader, AccordionPanel } from '@fluentui/react-components';
...
export const SearchListSection: React.FC<ISearchListSectionProps> = ({
    value,
    index,
}) => {
